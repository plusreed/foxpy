...
class LastFm:
    ...
    async def profile(self):
        ...
        if config.DEBUG:
            ...
            embed.set_author(name="PlusReed", url="https://last.fm/user/plusreed",
                             icon_url="https://lastfm-img2.akamaized.net/i/u/avatar170s/68a3eecca943458e39267bacae0a2" \
                                      "646.png")
            embed.set_footer(text="Generated by Fox", icon_url="https://cdn.discordapp.com/embed/avatars/0.png")

            embed.add_field(name="__Currently Scrobbling__", value="M83 - The Wizard")
